const DmytroPromise = require('./promise')

const t = setTimeout

describe('Dmytro Promise: ', () => {
  let promise
  let executorSpy
  ...
  beforeEach(() => {
    ...
    promise = new DmytroPromise(executorSpy)
  })

  test('should exists and to be typeof function', () => {
    expect(DmytroPromise).toBeDefined()
    expect(typeof DmytroPromise).toBe('function')
  })
  ...
  test('should catch error', () => {
    ...
    const errorPromise = new DmytroPromise(errorExecutor)
